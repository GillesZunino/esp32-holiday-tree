    ...
    switch (event) {
        ...
        case ESP_BT_GAP_CONFIG_EIR_DATA_EVT:
            if (param->config_eir_data.stat == ESP_BT_STATUS_SUCCESS) {
                ...
                ESP_LOGI(BtGapTag, "ESP_BT_GAP_CONFIG_EIR_DATA_EVT failed %d", param->config_eir_data.stat);
            }
        break;
        ...
        case ESP_BT_GAP_READ_REMOTE_NAME_EVT: {
            if (param->config_eir_data.stat == ESP_BT_STATUS_SUCCESS) {
                ...
                ESP_LOGI(BtGapTag, "ESP_BT_GAP_READ_REMOTE_NAME_EVT failed %d", param->read_rmt_name.stat);
            }
        }
        break;
        ...
        default: {
            ESP_LOGI(BtGapTag, "bt_gap_callback() received unknown event '%d'", event);
            break;
        }
    }
}
...
static void avrc_target_event_handler(uint16_t event, void *params) {
    ...
    switch (event) {
        ...
        case ESP_AVRC_TG_REMOTE_FEATURES_EVT: {
            ...
            ESP_LOGI(BtAvrcTargetTag, "[TG] ESP_AVRC_TG_REMOTE_FEATURES_EVT rmt_feats.feat_mask (0x%"PRIx32")", callbackParams->rmt_feats.feat_mask);
            ...
            ESP_LOGI(BtAvrcTargetTag, "[TG] ESP_AVRC_TG_REMOTE_FEATURES_EVT rmt_feats.ct_feat_flag (0x%"PRIx16")", callbackParams->rmt_feats.ct_feat_flag);
        ...
        case ESP_AVRC_TG_REGISTER_NOTIFICATION_EVT: {
            ...
            switch (eventId) {
                ...
                default:
                    ESP_LOGW(BtAvrcTargetTag, "[TG] ESP_AVRC_TG_REGISTER_NOTIFICATION_EVT -> Unknown Notification %s (0x%x), param: 0x%"PRIx32, get_avrc_notification_name(eventId), eventId, callbackParams->reg_ntf.event_parameter);
                break;
            }
        }
        break;
